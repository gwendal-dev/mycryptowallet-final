...
Position.create!([{portfolio_id: 1, coin_id: 1, entry_date: DateTime.current.to_date, amount: 1250, quantity: 0.5, exchange: "Binance manuel" }])
Position.create!([{portfolio_id: 1, coin_id: 2, entry_date: DateTime.current.to_date, amount: 40000, quantity: 1, exchange: "Binance manuel" }])
