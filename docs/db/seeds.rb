...
Coin.create!([{title: "ETH", price: 2560, avatar: "ETH.png", background: "eth2.jpeg"}])
Coin.create!([{title: "ADA", price: 1.6, avatar: "Ada.png", background: "ada2.png"}])
Coin.create!([{title: "LINK", price: 34, avatar: "Link.jpg", background: "link2.jpeg"}])
Coin.create!([{title: "BNB", price: 346, avatar: "bnb.png", background: "bnb2.png"}])
Coin.create!([{title: "DOGE", price: 0.34, avatar: "Doge.jpg", background: "doge2.jpeg"}])
Coin.create!([{title: "DOT", price: 24, avatar: "Dot.png", background: "dot2.jpeg"}])
Coin.create!([{title: "BNT", price: 8.3, avatar: "bancor-bnt-logo.png", background: "bnt2.jpeg"}])
Coin.create!([{title: "AAVE", price: 358, avatar: "AAVE.png", background: "aave2.jpeg"}])
puts 'coins done'
